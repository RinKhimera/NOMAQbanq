      ...
      questions: [
        {
          ...
          domain: "Cardiologie",
          question:
            "Quel est le traitement de première ligne pour l\'hypertension essentielle?",
          options: ["IEC", "ARA2", "Bêta-bloquants", "Diurétiques"],
          correctAnswer: "IEC",
        },

        {
          _id: "q2",
          domain: "Pédiatrie",
          question: "Quel vaccin est recommandé à 12 mois?",
          options: ["DTP", "ROR", "BCG", "HPV"],
          correctAnswer: "ROR",
        },
        {
          _id: "q3",
          domain: "Dermatologie",
          question: "La première ligne pour l\'acné légère est?",
          options: [
            "Isotrétinoïne",
            "Antibiotiques",
          ...
          correctAnswer: "Peroxyde de benzoyle",
        },
      ],
    }),
    [],

                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        >
                          <Clock className="mr-1 h-3 w-3" />~{estimatedDuration}{" "}
                          min
                        </Badge>
                      </div>
                  ...
                  <FormField
                    ...
                    render={({ field: endField }) => (
                      <FormItem>
                        ...
                        <FormDescription className="text-xs">
                          Les candidats pourront accéder à l&apos;examen pendant
                          cette période
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                          ...
                          <FormControl>
                            <Input
                              ...
                              onChange={(e) => {
                                ...
                                field.onChange(Math.min(60, Math.max(1, value)))
                              }}
                            />
                          </FormControl>
                  ...
                  <Alert className="border-amber-200 bg-amber-50 dark:border-amber-800 dark:bg-amber-900/20">
                    ...
                    <AlertDescription className="mt-2 space-y-2 text-sm text-amber-800 dark:text-amber-200">
                      ...
                      <p className="text-xs italic">
                        💡 La pause se déclenche automatiquement à 50% du temps,
                        ou peut être prise manuellement. Le candidat ne peut
                        prendre qu&apos;une seule pause.
                      </p>
                    </AlertDescription>
                  </Alert>
                </div>

      ...
      <div className="card-modern relative overflow-hidden p-12 text-center shadow-2xl">
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <div className="flex flex-col justify-center gap-6 sm:flex-row">
            <button className="btn-modern transform rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 px-12 py-4 text-lg font-semibold text-white shadow-xl transition-all duration-300 hover:scale-105 hover:from-blue-700 hover:to-indigo-700 hover:shadow-2xl">
              Commencer maintenant
              <ArrowRight className="ml-2 h-5 w-5" />
            </button>
            <button className="rounded-2xl border-2 border-blue-600 px-12 py-4 text-lg font-semibold text-blue-600 transition-all duration-300 hover:bg-blue-50 hover:shadow-lg dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-900/20">
              Nous contacter
            </button>
          </div>
        </div>

      ...
      <div className="card-modern relative overflow-hidden p-12 text-center shadow-2xl">
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <div className="flex flex-col justify-center gap-6 sm:flex-row">
            <Button
              className="btn-modern transform rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 px-12 py-4 text-lg font-semibold text-white shadow-xl transition-all duration-300 hover:scale-105 hover:from-blue-700 hover:to-indigo-700 hover:shadow-2xl"
              size={"lg"}
            >

          ...
          >
            <Link href={action.href}>
              ...
              >
                ...
                <div
                  className={cn(
                    "absolute -top-10 -right-10 h-32 w-32 rounded-full opacity-0 blur-3xl transition-opacity duration-500 group-hover:opacity-100",
                    action.bgGlow,
                  )}
                />
                ...
                {/* Content */}
                <h4 className="font-display mb-2 text-lg font-semibold text-gray-900 dark:text-white">
                  {action.title}
                </h4>

    ...
    <>
      ...
      >
        <p>
          ...
          l&apos;accès et l&apos;utilisation de la plateforme NOMAQbanq. En
          accédant à nos services, vous acceptez d&apos;être lié par ces
          conditions.
        </p>
        <p>
          L&apos;utilisation de la plateforme implique l&apos;acceptation pleine
          et entière des présentes conditions. Si vous n&apos;acceptez pas ces
      ...
      >
        <p>
          NOMAQbanq est une plateforme francophone de préparation à
          l&apos;examen EACMC Partie I (Examen d&apos;aptitude du Conseil
          médical du Canada). Nos services comprennent :
        </p>
        <ul className="list-disc space-y-2 pl-6">
          <li>
            Accès à une banque de plus de 5 000 questions à choix multiples
          </li>
          <li>
      ...
      >
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>
            Signaler immédiatement toute utilisation non autorisée de votre
            compte
          </li>
      ...
      >
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            Utiliser la plateforme uniquement à des fins personnelles et
            éducatives
          </li>
          <li>Ne pas partager votre compte avec d&apos;autres personnes</li>
          <li>
            Ne pas reproduire, distribuer ou commercialiser le contenu de la
            plateforme
          </li>
      ...
      >
        ...
        <p>
          Toute reproduction, représentation, modification ou distribution, même
          partielle, du contenu de la plateforme sans autorisation écrite
      ...
      >
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            Les prix sont affichés en dollars canadiens (CAD), taxes incluses
          </li>
          <li>
            Le paiement est effectué via notre prestataire sécurisé Stripe
          </li>
          <li>
            Les abonnements sont à durée déterminée et non renouvelés
            automatiquement
          </li>
          <li>
            Les remboursements sont accordés selon notre politique de
            remboursement
          </li>
        </ul>
      </LegalSection>
      ...
      >
        <p>
          NOMAQbanq s&apos;efforce de fournir des informations exactes et à
          jour. Cependant, nous ne garantissons pas :
        </p>
        <ul className="list-disc space-y-2 pl-6">
          <li>
          ...
          <li>
            La réussite à l&apos;examen EACMC suite à l&apos;utilisation de nos
            services
          </li>
      ...
      >
        <p>
          ...
          NOMAQbanq se réserve le droit de suspendre ou résilier votre accès en
          cas de :
        </p>
        <ul className="list-disc space-y-2 pl-6">
      ...
      >
        <p>
          NOMAQbanq se réserve le droit de modifier les présentes conditions à
      ...
      <LegalSection id="contact" number={10} title="Contact" accentColor="blue">
        <p>

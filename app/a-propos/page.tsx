      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="animate-slide-in-left">
            ...
            <div className="space-y-6 text-body text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <p>
                ...
                compréhension des défis spécifiques auxquels font face les
                candidats francophones.
              </p>
              <p>
                Aujourd&apos;hui, nous accompagnons des milliers de candidats
                vers la réussite, avec un taux de succès de 85% parmi nos
                utilisateurs actifs.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-4 mt-8">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-12 h-12 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-full border-2 border-white dark:border-gray-800 shadow-lg"
                  ></div>
                ))}
              </div>
              <div>
        ...
        <div className="mb-20">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-body-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Des valeurs fortes qui orientent chacune de nos décisions et
              actions
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {missions.map((mission, index) => (
              ...
              >
                <div
                  className={`w-20 h-20 bg-gradient-to-br ${mission.color} rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-xl group-hover:shadow-2xl group-hover:scale-110 transition-all duration-300`}
                >
          ...
          <div className="relative z-10 p-16 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              {values.map((value, index) => (
                <div
                  key={index}
                  className="glass-card-dark rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105"
                >
        ...
        <div className="mb-20">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-body-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Des témoignages authentiques de professionnels qui ont réussi
              grâce à NOMAQbank
            </p>
          </div>
          <div

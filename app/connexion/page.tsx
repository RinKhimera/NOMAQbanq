...
import { Stethoscope, Eye, EyeOff, ArrowRight, Sparkles, Shield, Zap } from 'lucide-react';
          ...
          <div className="space-y-10 animate-slide-in-left">
            ...
            <div className="space-y-8">
              ...
              <p className="text-body-lg text-gray-600 dark:text-gray-300 leading-relaxed max-w-lg">
                Connectez-vous à votre compte NOMAQbank et reprenez votre préparation 
                à l'EACMC là où vous vous êtes arrêté.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">Sécurisé et fiable</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">Vos données sont protégées</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">Accès instantané</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">À toutes vos ressources</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card rounded-2xl p-6 max-w-md border border-blue-100 dark:border-blue-800">
              <div className="flex items-center space-x-4 mb-4">
                ...
                />
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">Dr. Marie Dubois</p>
                  <p className="text-blue-600 dark:text-blue-400 text-sm font-medium">Résidente en médecine</p>
                </div>
              </div>
              <p className="text-gray-700 dark:text-gray-300 text-sm italic leading-relaxed">
                "NOMAQbank m'a aidée à réussir l'EACMC du premier coup. 
                Une plateforme indispensable !"
              </p>
            </div>

            <div className="text-center lg:text-left">
              <p className="text-gray-600 dark:text-gray-400 mb-4">Nouveau sur NOMAQbank ?</p>
            ...
            <div className="card-modern p-10 max-w-md mx-auto shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href="#" className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium hover:underline underline-offset-4">
                    Mot de passe oublié ?
                  </Link>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <Link href="/inscription" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-semibold hover:underline underline-offset-4">
                    Créer un compte
                  </Link>
                </div>
              </form>

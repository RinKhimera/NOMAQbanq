  ...
  return (
    <LegalLayout title="Politique de cookies" lastUpdated="15 janvier 2024">
      <div className="space-y-10">
        {/* Introduction */}
        <section className="rounded-2xl border border-amber-100 bg-gradient-to-br from-amber-50 to-orange-50 p-6 dark:border-amber-900/30 dark:from-amber-950/30 dark:to-orange-950/30">
            ...
            <div className="overflow-hidden rounded-2xl border border-green-200 bg-white shadow-sm dark:border-green-900/30 dark:bg-gray-900/50">
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 dark:from-green-950/30 dark:to-emerald-950/30">
                <div className="mb-4 flex items-center justify-between">
                  <h3 className="flex items-center gap-3 text-xl font-semibold text-gray-900 dark:text-white">
                ...
                <p className="mb-4 text-gray-700 dark:text-gray-300">
                  ...
                  plateforme. Ils vous permettent de naviguer sur le site et
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-start gap-2 rounded-lg bg-white/50 p-3 dark:bg-gray-900/50"
                    >
            ...
            <div className="overflow-hidden rounded-2xl border border-blue-200 bg-white shadow-sm dark:border-blue-900/30 dark:bg-gray-900/50">
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-6 dark:from-blue-950/30 dark:to-cyan-950/30">
                ...
                <p className="mb-4 text-gray-700 dark:text-gray-300">
                  ...
                  utilisez notre plateforme, nous permettant d&apos;améliorer
                  nos services.
                </p>
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
            ...
            <div className="overflow-hidden rounded-2xl border border-orange-200 bg-white shadow-sm dark:border-orange-900/30 dark:bg-gray-900/50">
              <div className="bg-gradient-to-r from-orange-50 to-red-50 p-6 dark:from-orange-950/30 dark:to-red-950/30">
                ...
                <p className="mb-4 text-gray-700 dark:text-gray-300">
                  ...
                  pertinentes et mesurer l&apos;efficacité de nos campagnes
                  marketing.
                </p>
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-teal-200 bg-gradient-to-br from-teal-50 to-cyan-50 p-6 dark:border-teal-900/30 dark:from-teal-950/30 dark:to-cyan-950/30">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Vous pouvez gérer vos préférences de cookies directement sur
                notre plateforme via le bandeau de consentement qui apparaît
                lors de votre première visite, ou en accédant aux paramètres de
                cookies dans votre compte.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mb-4 text-gray-700 dark:text-gray-300">
                ...
                Voici comment accéder aux paramètres de cookies :
              </p>
              <div className="grid gap-3 sm:grid-cols-2">
                {[
                  {
            ...
            <div className="rounded-xl border-l-4 border-amber-500 bg-amber-50 p-4 dark:bg-amber-950/30">
              <p className="flex items-start gap-3 text-sm text-gray-700 dark:text-gray-300">
                ...
                <span>
                  ...
                  Le blocage de certains cookies peut affecter votre expérience
                  sur notre plateforme et limiter certaines fonctionnalités.
                </span>
              </p>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="rounded-xl border border-rose-200 bg-gradient-to-br from-rose-50 to-pink-50 p-6 dark:border-rose-900/30 dark:from-rose-950/30 dark:to-pink-950/30">
            <p className="leading-relaxed text-gray-700 dark:text-gray-300">
              Nous respectons les signaux &quot;Do Not Track&quot; (DNT) de
              votre navigateur. Si vous activez le DNT, nous ne déposerons pas
              de cookies non essentiels et ne suivrons pas votre activité à des
              fins publicitaires.
            </p>
          </div>
        </section>

...
import { Heart, Sun as Lung, Brain, Activity, Baby, Users, ArrowLeft, Play, BookOpen, Clock, Target, Award, Star, CheckCircle, Lock, TrendingUp, BarChart3, Lightbulb, FileText, Users as UsersIcon, Shield } from 'lucide-react';
...
export default function DomainPage({ params }: DomainPageProps) {
  ...
  const domainData = {
    cardiologie: {
      ...
      topics: [
        { name: 'Insuffisance cardiaque', questions: 85, difficulty: 'Intermédiaire' },
        { name: 'Arythmies', questions: 92, difficulty: 'Avancé' },
        { name: 'Cardiopathies ischémiques', questions: 78, difficulty: 'Intermédiaire' },
        { name: 'Valvulopathies', questions: 65, difficulty: 'Avancé' },
        { name: 'Hypertension artérielle', questions: 70, difficulty: 'Débutant' },
        { name: 'ECG et troubles du rythme', questions: 60, difficulty: 'Intermédiaire' }
      ],
      stats: {
        averageScore: 72,
        completionRate: 89,
    ...
    pneumologie: {
      ...
      topics: [
        ...
        { name: 'Radiologie thoracique', questions: 80, difficulty: 'Intermédiaire' },
        { name: 'Insuffisance respiratoire', questions: 60, difficulty: 'Avancé' }
      ],
      stats: {
        averageScore: 68,
        completionRate: 85,
  ...
  const currentDomainData = domainData[domain.slug as keyof typeof domainData] || domainData.cardiologie;
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/30 pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-8 animate-fade-in-up">
          <Link href="/domaines" className="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors duration-200 group">
          ...
          <div className="animate-slide-in-left">
            ...
            <div className="flex items-center space-x-6 mb-8">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white text-lg">{domain.questionsCount}</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">Questions disponibles</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white text-lg">{currentDomainData.stats.averageScore}%</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">Score moyen</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline" className="border-2 border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 px-8 py-4 text-lg h-auto rounded-2xl font-semibold transition-all duration-300 hover:shadow-lg">
            ...
            <div className="relative">
              ...
              <div className="absolute -top-6 -right-6 glass-card rounded-2xl p-4 shadow-lg animate-float z-20">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white">{currentDomainData.stats.completionRate}%</p>
              ...
              <div className="absolute -bottom-6 -left-6 glass-card rounded-2xl p-4 shadow-lg animate-float z-20" style={{animationDelay: '1s'}}>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white">{currentDomainData.stats.timePerQuestion}s</p>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentDomainData.objectives.map((objective, index) => (
              <div key={index} className="card-modern p-6 hover:shadow-xl transition-all duration-300 animate-fade-in-scale" style={{animationDelay: `${index * 0.1}s`}}>
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed font-medium">{objective}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
              ...
              {currentDomainData.topics.map((topic, index) => (
                <div key={index} className="card-modern p-6 hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-400">{topic.questions} questions</span>
                    <div className="flex items-center space-x-1">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className={`h-4 w-4 ${
                          i < (topic.difficulty === 'Avancé' ? 5 : topic.difficulty === 'Intermédiaire' ? 3 : 2)
          ...
          <div className="animate-slide-in-right" style={{animationDelay: '0.2s'}}>
              ...
              {currentDomainData.tips.map((tip, index) => (
                <div key={index} className="card-modern p-6 hover:shadow-lg transition-all duration-300">
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed font-medium">{tip}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="card-modern p-8 mt-8">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 font-display">Statistiques de performance</h3>
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  <p className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">{currentDomainData.stats.averageScore}%</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">Score moyen</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">{currentDomainData.stats.completionRate}%</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">Taux de completion</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2">{currentDomainData.stats.timePerQuestion}s</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">Temps moyen</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-orange-600 dark:text-orange-400 mb-2">{currentDomainData.stats.difficulty}</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">Niveau</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative mb-16 overflow-hidden animate-fade-in-up">
            ...
            <div className="relative z-10 p-12 text-center">
              ...
              <p className="text-xl text-blue-100 mb-10 max-w-3xl mx-auto leading-relaxed">
                Créez un compte gratuit pour accéder aux {domain.questionsCount} questions, 
                aux explications détaillées et au suivi de vos progrès dans ce domaine.
              </p>
              
              <div className="grid md:grid-cols-3 gap-6 mb-10 max-w-3xl mx-auto">
                {[
                  { icon: BookOpen, text: `${domain.questionsCount} Questions` },
          ...
          <div className="card-modern p-12 shadow-xl">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-body-lg text-gray-600 dark:text-gray-300 mb-10 leading-relaxed">
                Commencez votre apprentissage dès maintenant avec nos questions adaptées 
                aux standards de l'EACMC et progressez à votre rythme.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                {isLoggedIn ? (
                  <Link href="/evaluation">
                ...
                <Link href="/domaines">
                  <Button variant="outline" className="border-2 border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 px-10 py-4 rounded-2xl font-semibold transition-all duration-300 hover:shadow-lg">

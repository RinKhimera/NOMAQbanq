    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/30 pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-20">
          {[
            { icon: BookOpen, number: '6', label: 'Domaines disponibles', color: 'from-blue-500 to-indigo-600' },
            { icon: Target, number: '2270', label: 'Questions au total', color: 'from-green-500 to-emerald-600' },
            { icon: Clock, number: '20s', label: 'Par question', color: 'from-purple-500 to-pink-600' },
            { icon: BarChart3, number: '85%', label: 'Taux de réussite', color: 'from-orange-500 to-red-600' }
          ].map((stat, index) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {domains.map((domain, index) => (
            <div key={domain.id} className="animate-fade-in-scale" style={{animationDelay: `${index * 0.1}s`}}>
          ...
          <div className="card-modern p-12 text-center shadow-xl">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-body-lg text-gray-600 dark:text-gray-300 mb-10 leading-relaxed">
                Choisissez un domaine ci-dessus ou commencez par une évaluation générale pour tester vos connaissances globales
              </p>

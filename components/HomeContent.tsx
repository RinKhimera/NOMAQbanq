            ...
            <div className="space-y-10 animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/evaluation">
                  <Button
                    variant="outline"
                    className="glass-card border-2 border-blue-200 dark:border-blue-700 text-blue-700 dark:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 px-8 py-4 text-lg h-auto rounded-2xl font-semibold transition-all duration-300 hover:shadow-lg"
                  >
                    {t("home.hero.try")}
                ...
                <div className="flex items-center space-x-2">
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="w-10 h-10 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-full border-2 border-white dark:border-gray-800"
                      ></div>
                    ))}
                  </div>
                  <div className="ml-3">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-8">
                      <div className="flex items-baseline mb-2">
                        ...
                        <span className="text-xl ml-2 text-blue-100">
                          {t("pricing.period")}
                        </span>
                      </div>
      ...
      <footer className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
              ...
              <div className="flex space-x-4">
                {[Facebook, Twitter, Linkedin, Instagram].map((Icon, index) => (
                  <a
                    key={index}
                    href="#"
                    className="w-12 h-12 bg-gray-800 rounded-2xl flex items-center justify-center hover:bg-gradient-to-br hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 transform hover:scale-110"
                  >
            ...
            {/* Quick Links */}
            <div>
              <h3 className="text-lg font-semibold mb-8 font-display">
                {t("footer.links")}
              </h3>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-gray-300 hover:text-blue-400 transition-colors duration-200 hover:underline underline-offset-4"
                    >
                      {link.name}
                    </Link>
                  </li>
              ...
              {[t("footer.privacy"), t("footer.terms"), t("footer.legal")].map(
                (link) => (
                  <a
                    key={link}
                    href="#"
                    className="text-gray-400 hover:text-blue-400 text-sm transition-colors duration-200 hover:underline underline-offset-4"
                  >
                    {link}
                  </a>
                )

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            ...
            <span className="text-2xl font-bold text-gray-900 dark:text-white font-display">NOMAQbank</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="glass-card border border-gray-200 dark:border-gray-700">
              ...
              <Link href="/connexion">
                <Button variant="ghost" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 px-6 py-2 rounded-xl font-medium transition-all duration-300">
                  {t('nav.login')}
                </Button>
              </Link>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-6 space-y-2 glass-card border-t border-white/20 dark:border-gray-800/50 mt-4 rounded-2xl shadow-xl bg-white/90 dark:bg-gray-900/90">
              ...
              <div className="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-3">
                <Link href="/connexion">
                  <Button variant="ghost" className="w-full justify-start text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-xl font-medium">
                    {t('nav.login')}
                  </Button>
                </Link>
                <Link href="/inscription">

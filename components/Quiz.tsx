...
export default function Quiz() {
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="card-modern p-8 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-5xl font-bold text-gray-900 dark:text-white mb-2 font-display">
                {percentage}%
              </p>
              ...
              {isExcellent ? (
                <>
                  ...
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-4 w-4 text-green-500" />
                    <span className="text-sm text-gray-700 dark:text-gray-300">
                      Pratiquez les cas complexes
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-4 w-4 text-green-500" />
                    <span className="text-sm text-gray-700 dark:text-gray-300">
                      Révisez les détails fins
                    </span>
                  </div>
                </>
              ) : isGood ? (
                <>
                  ...
                  <div className="flex items-center space-x-2">
                    <Target className="h-4 w-4 text-blue-500" />
                    <span className="text-sm text-gray-700 dark:text-gray-300">
                      Pratiquez plus régulièrement
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Target className="h-4 w-4 text-blue-500" />
                    <span className="text-sm text-gray-700 dark:text-gray-300">
                      Focalisez sur vos faiblesses
                    </span>
                  </div>
                </>
              ) : (
          ...
          <div className="relative mb-12 overflow-hidden">
            ...
            <div className="relative z-10 p-12 text-center">
              ...
              <p className="text-xl text-blue-100 mb-10 max-w-3xl mx-auto leading-relaxed">
                Accédez à plus de 2270 questions, des explications détaillées,
                des modules spécialisés et un suivi personnalisé de vos progrès.
                Rejoignez les 4000+ candidats qui nous font confiance.
              </p>
              {/* Features Grid */}
                ...
                <div className="flex items-center space-x-2">
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="w-8 h-8 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-full border-2 border-white/30"
                      ></div>
                    ))}
                  </div>
                  <div className="ml-3">
  ...
  if (!user) {
    return (
      <div className="max-w-4xl mx-auto text-center">
        <div className="card-modern p-12 shadow-2xl">
          ...
          <p className="text-body-lg text-gray-600 dark:text-gray-300 mb-10 max-w-2xl mx-auto">
            Pour accéder aux quiz et suivre vos progrès, vous devez vous
            connecter à votre compte ou en créer un nouveau.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link href="/connexion">
  ...
  return (
    <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="text-right">
            <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">
              {Math.round(
                ((currentQuestionIndex + (isAnswered ? 1 : 0)) / totalQuestions) *
                  100
              )}
              %
            </p>
      ...
      {/* Question Card */}
      <div className="card-modern overflow-hidden shadow-2xl mb-8 relative">
        {/* Question Image */}
        <Image
        ...
        <div className="absolute top-6 right-6">
          <div
            className={`px-3 py-1 rounded-full text-xs font-semibold ${
              currentQuestion.difficulty === "Avancé"
                ? "bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300"
                : currentQuestion.difficulty === "Intermédiaire"

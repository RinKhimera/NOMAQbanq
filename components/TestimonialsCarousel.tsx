    ...
    <div className="relative max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="flex items-center justify-center space-x-6">
              ...
              <div className="text-left">
                <p className="text-2xl font-bold text-white mb-2">{currentTestimonial.name}</p>
                <p className="text-blue-200 font-semibold text-lg">{currentTestimonial.role}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mt-8 w-full max-w-md mx-auto">
        ...
        <div className="flex justify-between mt-3 text-sm text-gray-600">
          <span className="font-medium">{currentIndex + 1} / {testimonials.length}</span>

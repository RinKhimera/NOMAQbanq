...
- `components/admin-protection.tsx:11-13` affirme : _« La protection serveur fait foi : les layouts admin appellent `requireRole(['admin'])` côté Server Component. »_ — **faux**.
